...
public interface ConstantParams {
  int    DEF_IMG_COMPRESS = 100;
  String DEF_IMG_DIR      = ".nomedia";
  ...
  String REGEX_FIND_ATTAG_TEXT       = "[@]+[A-Za-z0-9-ㄱ-ㅎㅏ-ㅣ가-힣]+\\b"; // "@([\\p{L}\\p{InThai}A-Za-z0-9_-]+)"
  String REGEX_FIND_MENTION_TAGS_IRI = "[@]+[a-zA-Z0-9-\uAC00-\uD7AF\u1100-\u11FF\u3130-\u318F]+\\b";
  String REGEX_FIND_HASHTAG          = "(?:(?i)(?<!color: {0,10})#[A-Za-z0-9-ㄱ-ㅎㅏ-ㅣ가-힣]+)"; //"#[A-Za-z0-9-가-힣]+";
  String REGEX_VALIDATE_URL          =
      "((?:(http|https|Http|Https|rtsp|Rtsp|HTTP|HTTPS):\\/\\/(?:(?:[a-zA-Z0-9\\$\\-\\_\\.\\+\\!\\*\\'\\(\\)"
